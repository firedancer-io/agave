...
#[unsafe(no_mangle)]
extern "C" fn fd_ext_poh_begin_leader( _bank: *const c_void, _slot: u64, _epoch: u64, _hashcnt_per_tick: u64, _tick_duration_nanos: u64, _cus_block_limit: u64, _cus_vote_cost_limit: u64, _cus_account_cost_limit: u64, _cus_allocated_data_size_limit: u64, _max_data_shreds: u64 ) {}
...
impl BankingSimulator {
    ...
    fn prepare_simulation(
        ...
        let cluster_info_for_broadcast = Arc::new(ClusterInfo::new(
            Node::new_localhost_with_pubkey(&random_keypair.pubkey(), 9001, 8003).info,
            random_keypair,
