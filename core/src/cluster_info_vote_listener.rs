...
impl ClusterInfoVoteListener {
    ...
    fn recv_loop(
        ...
        struct Stats {
            ...
            // FIREDANCER: Frankendancer reroutes gossiped votes to the dedup
            // tile and never pushes to verified_packets_sender, so the banking
            // channel stats below no longer have a meaningful value.
    ...
    fn process_last_vote_for_optimistic_confirmation(
        ...
        if reached_optimistic_confirmed {
            ...
            // FIREDANCER: Send an optimistically confirmed notification.
            {
