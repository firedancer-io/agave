...
impl Validator {
    ...
    pub fn new(
        ...
        *start_progress.write().unwrap() = ValidatorStartProgress::StartingServices;
        ...
        fn firedancer_publish_validator_info(account_indexes: &solana_accounts_db::accounts_index::AccountSecondaryIndexes, bank_forks: &Arc<RwLock<BankForks>>, block_commitment_cache: &Arc<RwLock<BlockCommitmentCache>>) {
