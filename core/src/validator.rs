...
impl Validator {
    ...
    pub fn new(
        ...
        *start_progress.write().unwrap() = ValidatorStartProgress::CleaningAccounts;
        ...
        let (record_sender, _record_receiver) = unbounded();
        ...
        *start_progress.write().unwrap() = ValidatorStartProgress::StartingServices;
        ...
        fn firedancer_publish_validator_info(account_indexes: &solana_accounts_db::accounts_index::AccountSecondaryIndexes, bank_forks: &Arc<RwLock<BankForks>>, block_commitment_cache: &Arc<RwLock<BlockCommitmentCache>>, force_accounts_scan: bool) {
            ...
            let acct_index_inactive = !account_indexes.contains(&AccountIndex::ProgramId) || !account_indexes.include_key(&solana_config_program_client::ID);
            ...
            let res = if acct_index_inactive {
                ...
                bank.accounts().accounts_db.index_scan_accounts(&bank.ancestors, bank.bank_id(), IndexKey::ProgramId(solana_config_program_client::ID), scan_fn, &ScanConfig::new(ScanOrder::Unsorted)).ok().map(|_| ())
            };
