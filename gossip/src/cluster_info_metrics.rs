...
pub struct GossipStats {
    ...
    pub(crate) packets_received_ping_message_failed_decode_count: Counter,
    pub(crate) packets_received_pong_message_failed_decode_count: Counter,
    pub(crate) packets_received_prune_message_failed_decode_count: Counter,
    pub(crate) packets_received_pull_request_failed_decode_count: Counter,
    pub(crate) packets_received_pull_response_failed_decode_count: Counter,
    pub(crate) packets_received_push_message_failed_decode_count: Counter,
    /* push messages crds decode failure count (assumes one crds value per push pkt!!!!!) */
    pub(crate) packets_received_push_msg_legacy_contact_info_failed_decode_count: Counter,
    pub(crate) packets_received_push_msg_vote_failed_decode_count: Counter,
    pub(crate) packets_received_push_msg_lowest_slot_failed_decode_count: Counter,
    pub(crate) packets_received_push_msg_legacy_snapshot_hashes_failed_decode_count: Counter,
    pub(crate) packets_received_push_msg_accounts_hashes_failed_decode_count: Counter,
    pub(crate) packets_received_push_msg_epoch_slots_failed_decode_count: Counter,
    pub(crate) packets_received_push_msg_legacy_version_failed_decode_count: Counter,
    pub(crate) packets_received_push_msg_version_failed_decode_count: Counter,
    pub(crate) packets_received_push_msg_node_instance_failed_decode_count: Counter,
    pub(crate) packets_received_push_msg_duplicate_shred_failed_decode_count: Counter,
    pub(crate) packets_received_push_msg_snapshot_hashes_failed_decode_count: Counter,
    pub(crate) packets_received_push_msg_contact_info_failed_decode_count: Counter,
    pub(crate) packets_received_push_msg_restart_last_voted_fork_slots_failed_decode_count: Counter,
    pub(crate) packets_received_push_msg_restart_heaviest_fork_failed_decode_count: Counter,
    /* end */
...
pub(crate) fn submit_gossip_stats(
    ...
    datapoint_info!(
        "cluster_info_failed_decode_stats",
        ("pull_request_failed_decode_count", stats.packets_received_pull_request_failed_decode_count.clear(), i64),
        ("pull_response_failed_decode_count", stats.packets_received_pull_response_failed_decode_count.clear(), i64),
        ("push_message_failed_decode_count", stats.packets_received_push_message_failed_decode_count.clear(), i64),
        ("prune_message_failed_decode_count", stats.packets_received_prune_message_failed_decode_count.clear(), i64),
        ("ping_message_failed_decode_count", stats.packets_received_ping_message_failed_decode_count.clear(), i64),
        ("pong_message_failed_decode_count", stats.packets_received_pong_message_failed_decode_count.clear(), i64),
    );
    datapoint_info!(
        "cluster_info_push_msg_crds_failed_decode_stats",
        ("LegacyContactInfo", stats.packets_received_push_msg_legacy_contact_info_failed_decode_count.clear(), i64),
        ("Vote", stats.packets_received_push_msg_vote_failed_decode_count.clear(), i64),
        ("LowestSlot", stats.packets_received_push_msg_lowest_slot_failed_decode_count.clear(), i64),
        ("LegacySnapshotHashes", stats.packets_received_push_msg_legacy_snapshot_hashes_failed_decode_count.clear(), i64),
        ("AccountsHashes", stats.packets_received_push_msg_accounts_hashes_failed_decode_count.clear(), i64),
        ("EpochSlots", stats.packets_received_push_msg_epoch_slots_failed_decode_count.clear(), i64),
        ("LegacyVersion", stats.packets_received_push_msg_legacy_version_failed_decode_count.clear(), i64),
        ("Version", stats.packets_received_push_msg_version_failed_decode_count.clear(), i64),
        ("NodeInstance", stats.packets_received_push_msg_node_instance_failed_decode_count.clear(), i64),
        ("DuplicateShred", stats.packets_received_push_msg_duplicate_shred_failed_decode_count.clear(), i64),
        ("SnapshotHashes", stats.packets_received_push_msg_snapshot_hashes_failed_decode_count.clear(), i64),
        ("ContactInfo", stats.packets_received_push_msg_contact_info_failed_decode_count.clear(), i64),
        ("RestartLastVotedForkSlots", stats.packets_received_push_msg_restart_last_voted_fork_slots_failed_decode_count.clear(), i64),
        ("RestartHeaviestFork", stats.packets_received_push_msg_restart_heaviest_fork_failed_decode_count.clear(), i64),
    );
    datapoint_info!(
