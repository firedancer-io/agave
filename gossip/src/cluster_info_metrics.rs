...
pub struct GossipStats {
    ...
    pub(crate) fd_pull_reqs: Counter,
    pub(crate) ag_epoch_slots_filter_hits: Counter,
    pub(crate) ag_epoch_slots_filter_misses: Counter,
    pub(crate) ag_pull_reqs: Counter,
}
...
pub(crate) fn submit_gossip_stats(
    ...
    datapoint_info!(
        ...
        ("pull_req_filters", stats.fd_pull_reqs.clear(), i64),
    );
    
    datapoint_info!(
        "cluster_info_ag_epoch_slots_filter",
        ("hits", stats.ag_epoch_slots_filter_hits.clear(), i64),
        ("misses", stats.ag_epoch_slots_filter_misses.clear(), i64),
        ("pull_req_filters", stats.ag_pull_reqs.clear(), i64),
    );
