...
pub mod poh_recorder {
  ...
  pub use crate::old_poh_recorder::{WorkingBankEntry, PohRecorderError, GRACE_TICKS_FACTOR, MAX_GRACE_SLOTS, PohLeaderStatus, Record, SharedWorkingBank, SharedTickHeight, SharedLeaderFirstTickHeight };
